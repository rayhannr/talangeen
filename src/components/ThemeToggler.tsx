...
export const ThemeToggler = () => {
  const onToggle = () => {
    ...
    const metaColor = colorMode === DARK_THEME ? '#0f172a' : '#f1f5f9'
  ...
  return (
    <button
      ...
      data-theme-toggle
      className="rounded-full border-0 p-2 transition-all hover:scale-90 active:scale-100 hover:bg-slate-200 dark:hover:bg-slate-800 outline-none"
      onClick={onToggle}
    >
      <svg
